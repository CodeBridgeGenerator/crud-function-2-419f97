...
const ServicePermissionsPage = (props) => {
    ...
    const onRowClick = ({data}) => {
        props.setOneServicePermission(data._id);
        navigate(`/servicePermissions/${data._id}`)
    };
...
const mapDispatch = (dispatch) => ({
    ...
    setOneServicePermission: (id) => dispatch.servicePermission.setOneServicePermission(id)
});
