    ...
    const menu = [
        {
            ...
            to: `/departments/${urlParams.singleDepartmentsId}/single`,
          }, 
{
    label: "User Profiles",
    icon: "pi pi-fw pi-cog",
    to: `/departments/${urlParams.singleDepartmentsId}/userProfiles`,
  }, 
{
    label: "Position Role Department",
    icon: "pi pi-fw pi-cog",
    to: `/departments/${urlParams.singleDepartmentsId}/positionRoleDepartment`,
  }, 
{
    label: "Ref Positions",
    icon: "pi pi-fw pi-cog",
    to: `/departments/${urlParams.singleDepartmentsId}/refPositions`,
  }, 
{
    label: "Sections",
    icon: "pi pi-fw pi-cog",
    to: `/departments/${urlParams.singleDepartmentsId}/sections`,
  }
            ]
        }
    ];
...
const mapState = (state) => {
    ...
    return { selectedDepartment, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOneDepartment: (id) => dispatch.department.getOneDepartment(id),
  });

export default connect(mapState, mapDispatch)(DepartmentLayout);
