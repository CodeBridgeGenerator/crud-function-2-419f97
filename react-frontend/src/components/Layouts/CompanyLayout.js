    ...
    const menu = [
        {
            ...
            to: `/companies/${urlParams.singleCompaniesId}/single`,
          }, 
{
    label: "User Profiles",
    icon: "pi pi-fw pi-cog",
    to: `/companies/${urlParams.singleCompaniesId}/userProfiles`,
  }, 
{
    label: "User Companies",
    icon: "pi pi-fw pi-cog",
    to: `/companies/${urlParams.singleCompaniesId}/userCompanies`,
  }, 
{
    label: "Branches",
    icon: "pi pi-fw pi-cog",
    to: `/companies/${urlParams.singleCompaniesId}/branches`,
  }, 
{
    label: "Departments",
    icon: "pi pi-fw pi-cog",
    to: `/companies/${urlParams.singleCompaniesId}/departments`,
  }, 
{
    label: "Sections",
    icon: "pi pi-fw pi-cog",
    to: `/companies/${urlParams.singleCompaniesId}/sections`,
  }
            ]
        }
    ];
...
const mapState = (state) => {
    ...
    return { selectedCompany, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOneCompany: (id) => dispatch.company.getOneCompany(id),
  });

export default connect(mapState, mapDispatch)(CompanyLayout);
