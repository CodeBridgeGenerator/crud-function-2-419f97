...
const IpLoginAccessLayout = (props) => {
...
const mapState = (state) => {
    ...
    return { selectedIpLoginAccess, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOneIpLoginAccess: (id) => dispatch.ipLoginAccess.getOneIpLoginAccess(id),
  });

export default connect(mapState, mapDispatch)(IpLoginAccessLayout);
