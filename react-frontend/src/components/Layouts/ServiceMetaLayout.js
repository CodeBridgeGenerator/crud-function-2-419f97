...
const mapState = (state) => {
    ...
    return { selectedServiceMeta, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOneServiceMeta: (id) => dispatch.serviceMeta.getOneServiceMeta(id),
  });

export default connect(mapState, mapDispatch)(ServiceMetaLayout);
