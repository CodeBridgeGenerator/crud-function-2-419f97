...
const mapState = (state) => {
    ...
    return { selectedInvitation, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOneInvitation: (id) => dispatch.invitation.getOneInvitation(id),
  });

export default connect(mapState, mapDispatch)(InvitationLayout);
