...
const MobileNumberLayout = (props) => {
    ...
    const menu = [
        {
            ...
            to: `/mobileNumbers/${urlParams.singleMobileNumbersId}/single`,
          }, 
{
    label: "User Profiles",
    icon: "pi pi-fw pi-cog",
    to: `/mobileNumbers/${urlParams.singleMobileNumbersId}/userProfiles`,
  }, 
{
    label: "Mobile Devices",
    icon: "pi pi-fw pi-cog",
    to: `/mobileNumbers/${urlParams.singleMobileNumbersId}/mobileDevices`,
  }, 
{
    label: "Addresses",
    icon: "pi pi-fw pi-cog",
    to: `/mobileNumbers/${urlParams.singleMobileNumbersId}/addresses`,
  }
            ]
        }
    ];
...
const mapState = (state) => {
    ...
    return { selectedMobileNumber, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOneMobileNumber: (id) => dispatch.mobileNumber.getOneMobileNumber(id),
  });

export default connect(mapState, mapDispatch)(MobileNumberLayout);
