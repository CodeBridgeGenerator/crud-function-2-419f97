    ...
    const menu = [
        {
            ...
            to: `/refPositions/${urlParams.singleRefPositionsId}/single`,
          }, 
{
    label: "Position Role Department",
    icon: "pi pi-fw pi-cog",
    to: `/refPositions/${urlParams.singleRefPositionsId}/positionRoleDepartment`,
  }
            ]
        }
    ];
...
const mapState = (state) => {
    ...
    return { selectedRefPosition, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOneRefPosition: (id) => dispatch.refPosition.getOneRefPosition(id),
  });

export default connect(mapState, mapDispatch)(RefPositionLayout);
