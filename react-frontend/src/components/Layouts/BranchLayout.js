    ...
    const menu = [
        {
            ...
            to: `/branches/${urlParams.singleBranchesId}/single`,
          }, 
{
    label: "User Profiles",
    icon: "pi pi-fw pi-cog",
    to: `/branches/${urlParams.singleBranchesId}/userProfiles`,
  }, 
{
    label: "Departments",
    icon: "pi pi-fw pi-cog",
    to: `/branches/${urlParams.singleBranchesId}/departments`,
  }, 
{
    label: "Sections",
    icon: "pi pi-fw pi-cog",
    to: `/branches/${urlParams.singleBranchesId}/sections`,
  }
            ]
        }
    ];
...
const mapState = (state) => {
    ...
    return { selectedBranch, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOneBranch: (id) => dispatch.branch.getOneBranch(id),
  });

export default connect(mapState, mapDispatch)(BranchLayout);
