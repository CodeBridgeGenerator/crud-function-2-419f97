...
const FieldPermissionLayout = (props) => {
...
const mapState = (state) => {
    ...
    return { selectedFieldPermission, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOneFieldPermission: (id) => dispatch.fieldPermission.getOneFieldPermission(id),
  });

export default connect(mapState, mapDispatch)(FieldPermissionLayout);
