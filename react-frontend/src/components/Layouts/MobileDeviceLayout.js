...
const MobileDeviceLayout = (props) => {
...
const mapState = (state) => {
    ...
    return { selectedMobileDevice, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOneMobileDevice: (id) => dispatch.mobileDevice.getOneMobileDevice(id),
  });

export default connect(mapState, mapDispatch)(MobileDeviceLayout);
