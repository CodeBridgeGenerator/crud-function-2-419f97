...
const ProfileStatusLayout = (props) => {
...
const mapState = (state) => {
    ...
    return { selectedProfileStatus, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOneProfileStatus: (id) => dispatch.profileStatus.getOneProfileStatus(id),
  });

export default connect(mapState, mapDispatch)(ProfileStatusLayout);
