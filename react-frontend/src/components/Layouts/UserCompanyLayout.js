...
const mapState = (state) => {
    ...
    return { selectedUserCompany, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOneUserCompany: (id) => dispatch.userCompany.getOneUserCompany(id),
  });

export default connect(mapState, mapDispatch)(UserCompanyLayout);
