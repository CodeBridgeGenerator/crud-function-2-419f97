...
const mapState = (state) => {
    ...
    return { selectedPreference, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOnePreference: (id) => dispatch.preference.getOnePreference(id),
  });

export default connect(mapState, mapDispatch)(PreferenceLayout);
