...
const mapState = (state) => {
    ...
    return { selectedFieldMeta, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOneFieldMeta: (id) => dispatch.fieldMeta.getOneFieldMeta(id),
  });

export default connect(mapState, mapDispatch)(FieldMetaLayout);
