...
const PositionRoleDepartmentLayout = (props) => {
...
const mapState = (state) => {
    ...
    return { selectedPositionRoleDepartment, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOnePositionRoleDepartment: (id) => dispatch.positionRoleDepartment.getOnePositionRoleDepartment(id),
  });

export default connect(mapState, mapDispatch)(PositionRoleDepartmentLayout);
