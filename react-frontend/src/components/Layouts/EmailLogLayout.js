...
const mapState = (state) => {
    ...
    return { selectedEmailLog, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOneEmailLog: (id) => dispatch.emailLog.getOneEmailLog(id),
  });

export default connect(mapState, mapDispatch)(EmailLogLayout);
